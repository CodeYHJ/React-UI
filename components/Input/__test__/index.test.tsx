...
describe('<Input/>', () => {
  ...
  describe('iconFix', () => {
    ...
    it('renders an `preIconFix and sufIconFix` component ', () => {
      const json = renderer.create(
        <Input
          placeholder="前/后置Icon"
          preIconFix={userIcon}
          sufIconFix={passwordIcon}
        />
      );
    ...
    describe('render', () => {
      describe('strFix Error', () => {
        ...
        it('renders an `sufStrFix Error` component ', () => {
          const json = renderer.create(
            <Input placeholder="http://baidu" sufStrFix=".com" error />
          );
      ...
      describe('strFix Disabled', () => {
        ...
        it('renders an `sufStrFix Disabled` component ', () => {
          const json = renderer.create(
            <Input placeholder="http://baidu" sufStrFix=".com" disabled />
          );
      ...
      describe('iconFix Error', () => {
        it('renders an `preIconFix Error` component ', () => {
          const json = renderer.create(
            <Input placeholder="前置Icon" preIconFix={userIcon} error />
          );
        ...
        it('renders an `sufIconFix Error` component ', () => {
          const json = renderer.create(
            <Input placeholder="后置Icon" sufIconFix={passwordIcon} error />
          );
      ...
      describe('iconFix Disabled', () => {
        it('renders an `preIconFix Disabled` component ', () => {
          const json = renderer.create(
            <Input placeholder="前置Icon" preIconFix={userIcon} disabled />
          );
        ...
        it('renders an `sufIconFix Disabled` component ', () => {
          const json = renderer.create(
            <Input placeholder="后置Icon" sufIconFix={passwordIcon} disabled />
          );
